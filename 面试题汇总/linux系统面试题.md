#自我介绍一下
```
各位面试官好，我叫刘子川，是西华大学2015级本科计算机科学与技术专业的学生，将于今年六月份毕业。我在2018年的9月至11月底这近三个月，曾在亚信科技有限公司实习，
当时应聘的是linux运维实习生，在近三个月的实习中，主要的工作有三点：
1.负责测试环境的代码发布
	jenkins配置好代码路径（SVN或GIT），然后拉代码，打tag。
	需要编译就编译，编译之后推送到发布服务器（jenkins里面可以调脚本），然后从分发服务器往下分发到业务服务器上。

2.编写一些简单的脚本编写
3.给测试环境搭建一些应用
除此之外，还有就是解决一些日常工作中遇到的问题
...
#25.redhat 6.X版本系统 和 centos 7.X版本有啥区别？
```
1.文件系统（6/ext4、7/xfs）
